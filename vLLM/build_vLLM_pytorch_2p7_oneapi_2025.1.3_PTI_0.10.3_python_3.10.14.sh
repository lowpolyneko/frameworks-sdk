...
CONDA_ENV_NAME=vLLM_pytorch_2p7_oneapi_2025p1p3_pti_0p10p3_python3p10p14
...
LOCAL_WHEEL_LOC=/lus/flare/projects/datasets/wheelforge/pytorch_2p7_oneapi_2025p1p3

#git clone --branch ratnampa/vllm_with_xccl https://github.com/ratnampa/vllm.git
cd vllm
pip install --no-cache-dir -r ${CONDA_ENV_INSTALL_DIR}/torchvision_ipex_pytorch_2p7_combined_for_test_suite_requirements.txt
