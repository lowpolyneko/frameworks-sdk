...
CONDA_ENV_NAME=triton_xpu_3.5.0+0a08c5ae19_pytorch_2.10.0a0+git7f4c3e7_oneapi_2025.2.0_python_3.12.8

WHEELHOUSE_TMP=/lus/flare/projects/datasets/softwares/envs/wheelhouse_tmp
PYTORCH_REPO_DIR=/lus/flare/projects/datasets/softwares/envs/repositories/pytorch_2.10.0a0+git7f4c3e7_10_15_2025/pytorch
...
TMP_WORK=/lus/flare/projects/datasets/softwares/envs/repositories/triton_xpu_git0a08c5a_10_15_2025
cd $TMP_WORK
...
#git checkout git checkout 0a08c5ae194c564910072e0d4b13016cb0b260a7
# HEAD is now at 0a08c5ae1 Use PyTorch cache key in 'extra-cache-key' action field for dependency installation: Commit message
...
#
## Install PyTorch_2.10.0a0+git7f4c3e7 wheel
pip install --no-deps --no-cache-dir --force-reinstall $WHEELHOUSE_TMP/torch-*.whl


## I pick these paths from 
# hossainm@aurora-uan-0010:/opt/aurora/25.190.0/spack/unified/0.10.1/install/modulefiles/Core/llvm> cat git.5708851-4ulhk4d.lua
...
#
#
## Nathan's wrapper script to bypass an LLVM version error
#export REAL_LLVMCFG=/opt/aurora/25.190.0/spack/unified/0.10.1/install/linux-sles15-x86_64/gcc-13.3.0/llvm-develop-git.5708851-4ulhk4d/bin/llvm-config
#FAKE_ROOT=/lus/flare/projects/datasets/softwares/envs/frameworks-standalone/triton_torchtitan_10_15_2025/llvm22-shim
#export LLVM_ROOT_DIR="$FAKE_ROOT"

#export SPIRV_LLVM_DIR=/opt/aurora/25.190.0/oneapi/compiler/2025.2/bin/compiler/llvm-spirv
