...
CONDA_ENV_NAME=vllm_0.10.1_torchtune_0.6.1_torchdata_0.11.0_torchao_0.12.0_h5py_3.14.0_mpi4py_4.1.0_torchvision_0.23.0_oneapi_2025.2.0_pti_0.12.3_numpy_2.0.2_python3p10p14
...
TMP_WORK=/lus/tegu/projects/datasets/software/wheelforge/repositories/vllm_0.10.1_rel_08_20_2025
cd $TMP_WORK
...
echo ""
echo "Completed build vllm/0.10.1 wheel with mpi4py/4.1.0 and oneapi/2025.2.0 with numpy/2.0.2 for PyTorch-2.8.0 with IPEX-2.8.10" 
echo ""
...
echo ""
echo "Finished installing the vllm/0.10.1 wheel and dependencies"
echo ""
