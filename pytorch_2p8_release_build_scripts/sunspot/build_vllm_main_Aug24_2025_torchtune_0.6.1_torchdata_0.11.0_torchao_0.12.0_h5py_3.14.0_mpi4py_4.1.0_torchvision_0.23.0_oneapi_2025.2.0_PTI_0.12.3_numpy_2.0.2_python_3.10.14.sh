...
CONDA_ENV_NAME=vllm_main_Aug24_2025_python3p10p14
...
TMP_WORK=/lus/tegu/projects/datasets/software/wheelforge/repositories/vllm_main_08_24_2025
cd $TMP_WORK
...
echo ""
echo "Completed build vllm/main/Aug24_2025 wheel with mpi4py/4.1.0 and oneapi/2025.2.0 with numpy/2.0.2 for PyTorch-2.8.0 with IPEX-2.8.10" 
echo ""
...
echo ""
echo "Finished installing the vllm/main/Aug24_2025 wheel and dependencies"
echo ""
