...
CONDA_ENV_NAME=dpctl_0.20.0_scikitlearnintelx_2025.8.0_pytorch_2.8.0_nre_oneapi_2025.2.0_numpy_2.0.2_python3p10p14
...
TMP_WORK=/lus/tegu/projects/datasets/software/wheelforge/repositories/dpctl_0.20.0_rel_08_22_2025
cd $TMP_WORK
...
echo ""
echo "Completed build dpctl/0.20.0 wheel with mpi4py/4.1.0 and oneapi/2025.2.0 with numpy/2.0.2 for PyTorch-2.8.0 with IPEX-2.8.10" 
echo ""

DPCTL_WHEEL_LOC=${TMP_WORK}/${CONDA_ENV_NAME}
pip install --no-deps --no-cache-dir --force-reinstall $DPCTL_WHEEL_LOC/dpctl-*.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"dpctl-install-$(tstamp).log"
echo ""
echo "Finished installing the dpctl/0.20.0 wheel and dependencies"
echo ""
