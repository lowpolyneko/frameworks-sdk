...
CONDA_ENV_NAME=deepspeed_python_build_0.17.5_nre_pytorch_2.8.0_oneapi_2025.2.0_numpy_2.0.2_python3p10p14
...
python -m build --wheel --no-isolation --outdir ${TMP_WORK}/${CONDA_ENV_NAME} 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"deepspeed-build-whl-$(tstamp).log"
...
echo ""
echo "Completed build deepspeed/0.17.5 wheel with DS_BUILD_OPS with mpi4py/4.1.0 and oneapi/2025.2.0 with numpy/2.0.2 for PyTorch-2.8.0 with IPEX-2.8.10" 
echo ""
