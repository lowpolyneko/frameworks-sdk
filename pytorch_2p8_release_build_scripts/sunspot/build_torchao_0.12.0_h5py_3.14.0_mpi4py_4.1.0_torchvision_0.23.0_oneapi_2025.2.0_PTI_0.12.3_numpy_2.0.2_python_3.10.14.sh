...
CONDA_ENV_NAME=torchao_0.12.0_h5py_3.14.0_mpi4py_4.1.0_torchvision_0.23.0_oneapi_2025.2.0_pti_0.12.3_numpy_2.0.2_python3p10p14
...
TMP_WORK=/lus/tegu/projects/datasets/software/wheelforge/repositories/torchao_0.12.0_rel_08_19_2025
cd $TMP_WORK

LOCAL_WHEEL_LOC=/lus/tegu/projects/datasets/software/wheelhouse

pip install --no-cache-dir -r ${LOCAL_WHEEL_LOC}/torchao_0.12.0_h5py_3.14.0_torchvision_0.23.0_ipex_2.8.10_pytorch_2.8.0_triton_xpu_3.4.0_combined_requirements.txt
...
echo ""
echo "Completed build torchao/0.12.0 wheel with mpi4py/4.1.0 and oneapi/2025.2.0 with numpy/2.0.2 for PyTorch-2.8.0 with IPEX-2.8.10" 
echo ""

TORCHAO_WHEEL_LOC=${TMP_WORK}/${CONDA_ENV_NAME}
pip install --no-deps --no-cache-dir --force-reinstall $TORCHAO_WHEEL_LOC/torchao-*.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"torchao-install-$(tstamp).log"
echo ""
echo "Finished installing the torchao/0.12.0 wheel and dependencies"
echo ""
