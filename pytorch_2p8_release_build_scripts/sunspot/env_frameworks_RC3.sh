...
CONDA_ENV_NAME=frameworks_2025.2.0_RC3
...
pip install --no-cache-dir ${TRY_WHEEL_LOC}/pytorch_triton_xpu-*.whl
...
echo ""
echo "Finished installing the environment: frameworks/2025.2.0_RC3"
echo ""
