...
CONDA_ENV_NAME=torchdata_0.11.0_torchao_0.12.0_h5py_3.14.0_mpi4py_4.1.0_torchvision_0.23.0_oneapi_2025.2.0_pti_0.12.3_numpy_2.0.2_python3p10p14
...
TMP_WORK=/lus/tegu/projects/datasets/software/wheelforge/repositories/torchdata_0.11.0_rel_08_20_2025
cd $TMP_WORK
...
echo ""
echo "Completed build torchdata/0.11.0 wheel with mpi4py/4.1.0 and oneapi/2025.2.0 with numpy/2.0.2 for PyTorch-2.8.0 with IPEX-2.8.10" 
echo ""

TORCHDATA_WHEEL_LOC=${TMP_WORK}/${CONDA_ENV_NAME}
pip install --no-deps --no-cache-dir --force-reinstall $TORCHDATA_WHEEL_LOC/torchdata-*.whl 2>&1 | tee ${TMP_WORK}/${CONDA_ENV_NAME}/"torchdata-install-$(tstamp).log"
echo ""
