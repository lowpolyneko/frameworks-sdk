...
CONDA_ENV_NAME=nre_order_last_deepspeed_pip_0.17.5_pytorch_2.8.0_oneapi_2025.2.0_numpy_2.0.2_python3p10p14
...
echo ""
echo "Finished installing the NRE dependencies as last items"
echo ""
