...
REPO_SRC_DIR=/lus/flare/projects/Aurora_deployment/datascience/software/frameworks-standalone/pytorch_2p8
...
# location of inputs
[[ -z "${REPO_SRC_DIR:-}" ]] && REPO_SRC_DIR=/frameworks-standalone/pytorch_2p8
...
#A21_SDK_PTIROOT_OVERRIDE=/opt/aurora/24.347.0/oneapi/pti/latest ## 0.11.0
